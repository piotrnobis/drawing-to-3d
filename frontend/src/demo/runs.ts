...
const manifoldGate: GateRow[] = [
  { label: "overall width", kind: "bbox_x", target: 111.25, tol: 0.5, measured: 111.262, status: "pass" },
  { label: "overall depth", kind: "bbox_y", target: 57.5, tol: 0.5, measured: 57.518, status: "pass" },
  { label: "overall height", kind: "bbox_z", target: 78.75, tol: 0.5, measured: 78.757, status: "pass" },
  { label: "circular flange outer diameter", kind: "other", target: 57.5, tol: 0.5, measured: null, status: "unmeasured" },
  { label: "circular flange bolt circle diameter", kind: "bolt_circle", target: 47.5, tol: 0.5, measured: 47.5, status: "pass" },
  ...
  { label: "main tube outer diameter", kind: "other", target: 25, tol: 0.5, measured: null, status: "unmeasured" },
  { label: "main tube inner diameter", kind: "hole_diameter", target: 20, tol: 0.5, measured: 20, status: "pass" },
  { label: "left branch distance from left face", kind: "spacing", target: 23.75, tol: 0.5, measured: null, status: "unmeasured" },
  { label: "left branch height from centerline", kind: "spacing", target: 28.75, tol: 0.5, measured: null, status: "unmeasured" },
  { label: "diamond flange thickness", kind: "thickness", target: 3.75, tol: 0.5, measured: null, status: "unmeasured" },
  { label: "diamond flange hole spacing", kind: "hole_pitch", target: 35, tol: 0.5, measured: 35, status: "pass" },
  { label: "diamond flange hole diameter", kind: "hole_diameter", target: 5, tol: 0.5, measured: 5, status: "pass" },
  { label: "diamond flange hole count", kind: "hole_count", target: 2, tol: 0.5, measured: 2, status: "pass" },
  { label: "left branch outer diameter", kind: "other", target: 20, tol: 0.5, measured: null, status: "unmeasured" },
  { label: "left branch inner diameter", kind: "hole_diameter", target: 15, tol: 0.5, measured: 15, status: "pass" },
  { label: "main elbow bend radius", kind: "other", target: 18.75, tol: 0.5, measured: null, status: "unmeasured" },
  { label: "square flange distance from left branch", kind: "spacing", target: 51.25, tol: 0.5, measured: null, status: "unmeasured" },
  { label: "square flange height from centerline", kind: "spacing", target: 50, tol: 0.5, measured: null, status: "unmeasured" },
  { label: "square flange thickness", kind: "thickness", target: 5, tol: 0.5, measured: null, status: "unmeasured" },
  { label: "square flange outer size", kind: "other", target: 50, tol: 0.5, measured: null, status: "unmeasured" },
  ...
  { label: "right branch distance from square flange", kind: "spacing", target: 36.25, tol: 0.5, measured: null, status: "unmeasured" },
  { label: "right branch offset from square flange top", kind: "spacing", target: 17.5, tol: 0.5, measured: null, status: "unmeasured" },
  { label: "right branch outer diameter", kind: "other", target: 20, tol: 0.5, measured: null, status: "unmeasured" },
  { label: "right branch inner diameter", kind: "hole_diameter", target: 15, tol: 0.5, measured: 15, status: "pass" },
];
...
export const manifoldRun: DemoRun = {
  ...
  stlUrl: `${M}/final.stl`,
  gate: { rows: manifoldGate, nPass: 15, nMeasured: 15, verdict: "PASS · 15/30 verified, 15 unmeasured" },
};
